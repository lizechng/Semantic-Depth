...
parser.add_argument('--load_external_mod', type=str2bool, nargs='?', const=True, default=True,
...
# Paths settings
parser.add_argument('--save_path', default='fine_tune/', help='save path')
...
parser.add_argument('--metric_1', type=str, default='mae', choices=allowed_metrics(),
                    help="metric to use during evaluation")
parser.add_argument('--wcoarse', type=float, default=0.7, help="weight base loss")  # TODO:
parser.add_argument('--wcls', type=float, default=0.7, help="weight base loss")
parser.add_argument('--wdepth', type=float, default=1.5, help="weight base loss")
parser.add_argument('--wseg', type=float, default=0.2, help="weight base loss")
parser.add_argument('--wedge', type=float, default=0.3, help="weight base loss")
# Cudnn
...
def main():
    ...
    if args.pretrained and not args.resume:
        if not args.load_external_mod:
            ...
            check = torch.load('./img_seg_edge/sdn_adam_mse_0.001_rgb_batch2_pretrainTrue_wcoarse0.7_wcls0.7_wdepth1_wseg1_wedge0.1_patience7_num_samplesNone_multiFalse/'
                               'checkpoint_model_epoch_149.pth.tar')
            ...
            check = torch.load(
                './img_seg_edge/sdn_adam_mse_0.001_rgb_batch2_pretrainTrue_wcoarse0.7_wcls0.7_wdepth1_wseg1_wedge0.1_patience7_num_samplesNone_multiFalse/'
                'checkpoint_model_epoch_149.pth.tar')
