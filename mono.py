...
parser.add_argument('--mod', type=str, default='monod', choices=Models.allowed_models(), help='Model for use')
...
# Paths settings
parser.add_argument('--save_path', default='monod/', help='save path')
...
parser.add_argument('--wdepth', type=float, default=1, help="weight base loss")
parser.add_argument('--wseg', type=float, default=1, help="weight base loss")
parser.add_argument('--wedge', type=float, default=0.1, help="weight base loss")
# Cudnn
...
def validate(loader, model, criterion_depth, epoch=0):
    # batch_time = AverageMeter()
    losses = AverageMeter()
